...
def init():
    ...
    contract_template_one = w3.eth.contract(
        address=all_address["WalletTemplateOne"], abi=contract_template_one_abi)

    return contract_wallet_hub, contract_template_infos, contract_wallet_infos, contract_wallet_admin,contract_template_one


WalletHub, WalletTemplateInfos, WalletInfos, WalletAdmin,WalletTemplateOne = init()
